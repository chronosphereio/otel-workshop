...
public class InventoryController {
    private static final Meter meter = GlobalOpenTelemetry.getMeter("inventory");
    private static final LongCounter productCounter = meter
            .counterBuilder("app.inventory.prod_sold")
            .setDescription("Counts product sold by id")
            .build();
    private static final AttributeKey<String> productTypeKey = AttributeKey.stringKey("app.inventory.prod_type");
    ...
    public void buyProduct(@RequestParam int id) throws InterruptedException {
        ...
        ProducerRecord<String, String> record = new ProducerRecord<>("orders", "" + id,
                "Product with id " + id + " has been bought");
        record.headers().add("product-id", String.valueOf(id).getBytes());

        productCounter.add(1, Attributes.of(
                productTypeKey, items.get(id - 1).getName()));
    ...
    private static List<InventoryItem> loadItems() {
        return List.of(
                ...
                new InventoryItem(13, "Sunglasses",
                        "https://emoji.aranja.com/static/emoji-data/img-apple-160/1f576-fe0f.png"),
                new InventoryItem(14, "Womans Hat",
                        "https://emoji.aranja.com/static/emoji-data/img-apple-160/1f452.png"),
                ...
                new InventoryItem(20, "Eyeglasses",
                        "https://emoji.aranja.com/static/emoji-data/img-apple-160/1f453.png"));
    }
